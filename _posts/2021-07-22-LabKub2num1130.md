---
layout: post
title: Лабораторная JSON PATH Basics-3, курс Certified Kubernetes Administrator (CKA)
---

<div id="rt_scenario" image="CKA/1130 - lab.jpg"></div>
...
<script>
    ...
    var startLab = function() {
        ...
        $('#lab-img').remove();
        var div_source_code = ' <iframe height="100%" width="100%" src="https://rotoro-cloud.github.io/JSON-PATH-quiz/#!/?questions=json_path3" frameborder="0" style="overflow:hidden;overflow-x:hidden;overflow-y:hidden;height:100%;width:100%;position:absolute;top:0px;left:0px;right:0px;bottom:0px" height="100%" width="100%"></iframe>';
